...
public class Menu {
    ...
    public static final String[] VOCI_Fruitore = new String[]{"Visualizzazione delle radici e dei parametri di sistema","Pubblicazione prodotto","Modifica una offerta già esistente","Visualizza le tue offerte","Visualizza le offerte di una categoria","Proporre uno scambio","Controllare gli scambi"};
